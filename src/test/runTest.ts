...
const standardTestSuccess = runTest(path.resolve(__dirname, "./test.ts"), "tests standard");

const errorTestSuccess = runTest(path.resolve(__dirname, "./error-test.ts"), "tests d'erreur spécifiques");
